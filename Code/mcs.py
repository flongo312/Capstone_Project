...
for label, (weights_df, horizon, continuous_contribution) in time_horizons.items():
    ...
    plt.plot(np.arange(num_days), np.median(shocked_results, axis=0), color='blue', linewidth=3, label='Median Simulation')
    plt.title(f'Cumulative Returns Over Time ({horizon} Years)', fontsize=26, weight='bold')
    ...
    plt.axvline(mean_final_value, color='red', linestyle='dashed', linewidth=3, label='Mean')
    plt.axvline(median_final_value, color='green', linestyle='dashed', linewidth=3, label='Median')
    plt.axvline(percentile_10, color='orange', linestyle='dashed', linewidth=3, label='10th Percentile')
    plt.axvline(percentile_90, color='orange', linestyle='dashed', linewidth=3, label='90th Percentile')
    plt.title(f'Distribution of Final Portfolio Values ({horizon} Years)', fontsize=26, weight='bold')
    plt.xlabel('Final Portfolio Value ($)', fontsize=22)
