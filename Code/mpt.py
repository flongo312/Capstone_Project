...
ticker_info = {
    ...
    'GOOGL': 'Google', 'NVDA': 'NVIDIA', 'META': 'Meta',
    'AMD': 'AMD', 'BAC': 'Bank of America', 'MSFT': 'Microsoft',
    'NFLX': 'Netflix', 'JPM': 'JPMorgan', 'V': 'Visa',
    'DIS': 'Disney', 'CSCO': 'Cisco', 'XOM': 'Exxon Mobil',
    'PFE': 'Pfizer', 'KO': 'Coca-Cola', 'PEP': 'PepsiCo',
    'INTC': 'Intel', 'CRM': 'Salesforce', 'T': 'AT&T',
    'MRK': 'Merck', 'WMT': 'Walmart', 'NKE': 'Nike',
    'GE': 'GE', 'COST': 'Costco', 'MCD': 'McDonald\'s',
    'SBUX': 'Starbucks', 'IBM': 'IBM', 'WFC': 'Wells Fargo',
    'UNH': 'UnitedHealth', 'ORCL': 'Oracle', 'QCOM': 'Qualcomm',
    'AVGO': 'Broadcom', 'TM': 'Toyota', 'ADBE': 'Adobe',
    'TXN': 'Texas Instruments', 'HON': 'Honeywell', 'MO': 'Altria',
    'MDT': 'Medtronic', 'SPG': 'SPG', 'AXP': 'American Express',
    'GS': 'Goldman Sachs', 'LMT': 'Lockheed', 'BMY': 'Bristol-Myers',
    'BLK': 'BlackRock', 'SPY': 'SPDR S&P 500 ETF', 'QQQ': 'NASDAQ-100 ETF',
    'IWM': 'Russell 2000 ETF', 'GLD': 'Gold ETF', 'EEM': 'Emerging Markets ETF',
    'VOO': 'Vanguard S&P 500', 'XLF': 'Financials ETF', 'TQQQ': 'ProShares QQQ',
    'DIA': 'Dow Jones ETF', 'LQD': 'Investment Grade Bond ETF', 'IVV': 'iShares S&P 500',
    'VTI': 'Vanguard Total Market', 'XLK': 'Tech Sector SPDR ETF', 'VNQ': 'Real Estate ETF',
    'HYG': 'High Yield Bond ETF', 'XLV': 'Health Care ETF', 'XLE': 'Energy ETF',
    'XLY': 'Consumer Discretionary ETF', 'XLP': 'Consumer Staples ETF', 'XLU': 'Utilities ETF',
    'GDX': 'Gold Miners ETF', 'XLI': 'Industrial ETF', 'IWF': 'Russell 1000 Growth ETF',
    'IWB': 'Russell 1000 ETF', 'IJH': 'Mid-Cap ETF', 'IYR': 'U.S. Real Estate ETF',
    'VUG': 'Vanguard Growth ETF', 'IJR': 'Small-Cap ETF', 'IWN': 'Russell 2000 Value ETF',
    'EFA': 'MSCI EAFE ETF', 'VWO': 'FTSE Emerging Markets ETF', 'SHY': '1-3 Year Treasury Bond ETF',
    'USO': 'Oil Fund', 'TLT': '20+ Year Treasury Bond ETF', 'VGK': 'Europe ETF',
    'XOP': 'Oil & Gas ETF', 'IEFA': 'Core MSCI EAFE ETF', 'IEMG': 'Core MSCI Emerging Markets ETF',
    'PFF': 'Preferred and Income Securities ETF', 'EWT': 'Taiwan ETF', 'EWJ': 'Japan ETF',
    'IWC': 'Micro-Cap ETF', 'VB': 'Small-Cap ETF', 'SCHX': 'U.S. Large-Cap ETF',
    'VIG': 'Dividend Appreciation ETF', 'SCHF': 'International Equity ETF', 'EZU': 'Eurozone ETF',
    'IGV': 'Tech-Software Sector ETF', 'VCSH': 'Short-Term Corporate Bond ETF', 'SPDW': 'Developed World ex-US ETF',
    'VFIAX': 'Vanguard 500 Index Fund', 'VTSAX': 'Vanguard Total Stock Market Index Fund', 'FXAIX': 'Fidelity 500 Index Fund',
    'FCNTX': 'Fidelity Contrafund', 'AGTHX': 'American Funds Growth Fund', 'TRBCX': 'T. Rowe Price Growth Fund',
    'VBTLX': 'Vanguard Total Bond Market Index Fund', 'SWPPX': 'Schwab S&P 500 Index Fund', 'VWELX': 'Vanguard Wellington Fund',
    'DODGX': 'Dodge & Cox Stock Fund', 'VIGAX': 'Vanguard Growth Index Fund', 'PRGFX': 'T. Rowe Price Growth Stock Fund',
    'VWIAX': 'Vanguard Wellesley Income Fund', 'DFELX': 'Dimensional U.S. Core Equity 2 ETF', 'VIMAX': 'Vanguard Mid Cap Index Fund',
    'VPCCX': 'Vanguard PRIMECAP Core Fund', 'VEIPX': 'Vanguard Equity-Income Fund', 'VWINX': 'Vanguard Wellesley Income Fund',
    'VTIAX': 'Vanguard Total International Stock Index Fund', 'PTTRX': 'PIMCO Total Return Fund', 'POAGX': 'PRIMECAP Odyssey Growth Fund',
    'RPMGX': 'T. Rowe Price Mid-Cap Growth Fund', 'VWUAX': 'Vanguard U.S. Growth Fund', 'FAGIX': 'Fidelity Capital & Income Fund',
    'VGHAX': 'Vanguard Health Care Fund', 'FFIDX': 'Fidelity Fund', 'FBGRX': 'Fidelity Blue Chip Growth Fund',
    'FSPTX': 'Fidelity Tech Portfolio', 'FDGRX': 'Fidelity Growth Company Fund', 'VWNDX': 'Vanguard Windsor Fund',
    'JATTX': 'Janus Henderson Triton Fund', 'SGENX': 'First Eagle Global Fund', 'RWMFX': 'Washington Mutual Fund',
    'PRHSX': 'T. Rowe Price Health Fund', 'FLPSX': 'Fidelity Low-Priced Stock Fund', 'FBALX': 'Fidelity Balanced Fund',
    'FAIRX': 'Fairholme Fund', 'VGSLX': 'Vanguard Real Estate Index Fund', 'VDIGX': 'Vanguard Dividend Growth Fund',
    'MGVAX': 'MFS Value Fund', 'PRWCX': 'T. Rowe Price Capital Fund', 'PARNX': 'Parnassus Mid Cap Fund',
    'PRNHX': 'T. Rowe Price New Horizons Fund', 'RYVPX': 'Royce Value Plus Fund', 'SWHGX': 'Schwab Health Care Fund',
    'VHCAX': 'Vanguard Health Care Fund', 'VSEQX': 'Vanguard Strategic Equity Fund', '^GSPC': 'S&P 500',
